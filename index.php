...
session_start();
$errors = array();
$db = mysqli_connect('localhost', 'root', '', 'Data_Validation'); // DB connection

//server name, user name, empty password,DB name.
...
<div class="container">
    ...
    <div class="col-sm-10 col-sm-offset-1 jumbotron">
        <form method = "post" action="index.php">
            ...
            <button type="submit" class="btn btn-primary" name="Register">OK</button>
        </form>
    </div>
